...
This data set information was obtained from http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
...
### Rows 
Rows contain individual samples

The first row is a header containing the names of variables

### Columns
* Column 1: a factor vector indicating the type of activity
* Column 2: a numeric vector where each number represents a participant
* Columns 3-68: each column represents a measured feature

#### Naming conventions for columns 3-68:
* "mean()" represents a mean value
* "std()" represents a standard deviation value
* A trailing "X", "Y", or "Z" represents the direction measured
